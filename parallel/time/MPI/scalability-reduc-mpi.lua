...
experiment_name = "reduc_mpi_scalability"
...
run_command    = "<executable> 4000000"
...
multiruns_params = {
    {mpi_command = 'mpirun -np <number_processes>', number_processes = 2, name = '2x1'},
    {mpi_command = 'mpirun -np <number_processes>', number_processes = 3, name = '3x1'},
    {mpi_command = 'mpirun -np <number_processes>', number_processes = 4, name = '4x1'},
    {mpi_command = 'mpirun -np <number_processes>', number_processes = 5, name = '5x1'},
    {mpi_command = 'mpirun -np <number_processes>', number_processes = 6, name = '6x1'},
    {mpi_command = 'mpirun -np <number_processes>', number_processes = 7, name = '7x1'},
    {mpi_command = 'mpirun -np <number_processes>', number_processes = 8, name = '8x1'},
}
