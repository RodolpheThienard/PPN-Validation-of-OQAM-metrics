...
multiruns_params = {
    {envv_OMP_NUM_THREADS = 2, name = '1x2'},
    {envv_OMP_NUM_THREADS = 3, name = '1x3'},
    {envv_OMP_NUM_THREADS = 4, name = '1x4'},
    {envv_OMP_NUM_THREADS = 5, name = '1x5'},
    {envv_OMP_NUM_THREADS = 6, name = '1x6'},
    {envv_OMP_NUM_THREADS = 7, name = '1x7'},
    {envv_OMP_NUM_THREADS = 8, name = '1x8'},
}
