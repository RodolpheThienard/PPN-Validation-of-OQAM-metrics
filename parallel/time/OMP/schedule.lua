...
experiment_name = "reduc_omp_scal"
...
run_command    = "<executable> 10000000"
...
multiruns_params = {
    {name = "static", envv_OMP_NUM_THREADS = 2, envv_OMP_SCHEDULE = "static"},
    {name = "dynamic", envv_OMP_NUM_THREADS = 2, envv_OMP_SCHEDULE = "dynamic"},
    {name = "guided", envv_OMP_NUM_THREADS = 2, envv_OMP_SCHEDULE = "guided"},
}
...
environment_variables = {
  ...
  {name = "OMP_SCHEDULE", value = "static,1"},
}
